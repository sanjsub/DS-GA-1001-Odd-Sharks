...
def model_bakeoff():
    ...
    for ind, datagroup in enumerate(sub):
        ...
        param_dict_rf['datagroup'] = 4 - ind
        best_model_to_csv(param_dict_rf, 'rf3_prec_rv_dg4')
        ...
        param_dict_gbt['datagroup'] = 4 - ind
        best_model_to_csv(param_dict_gbt, 'gbt3_prec_rv_dg4')
